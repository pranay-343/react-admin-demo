...

{
  ...
  Tabs.propTypes = {
    ...
    orientation: /*#__PURE__*/PropTypes.oneOf( /*#__PURE__*/Object.values(exports.TabsOrientation)),
...
var Tab = /*#__PURE__*/utils.forwardRefWithAs(function Tab(_ref3, forwardedRef) {
  ...
  var handleBlur = utils.useEventCallback(utils.wrapEvent(onFocus, function () {
    setFocusedIndex(-1);
  }));
